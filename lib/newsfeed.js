module.exports = function(db){
	...
	this.post = function(owner_id, privacy, newsfeed, callback){
		db.query('INSERT INTO newsfeed_items (owner_id, from_id, fid, privacy, newsfeed, time) VALUES(?, NOW())', [[owner_id, owner_id, null, privacy, newsfeed]], function(err, data){
			if(err){
				console.log(err);
				callback(false, err);
				return;
